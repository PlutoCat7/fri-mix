...
+ (instancetype)modelWithAsset:(id)asset type:(TZAssetModelMediaType)type timeLength:(NSString *)timeLength creationDate:(NSDate *)creationDate{
...
@implementation XWPhotoDateModel

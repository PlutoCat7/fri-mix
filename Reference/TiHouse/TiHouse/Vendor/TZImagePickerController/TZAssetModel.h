...
@property (nonatomic, copy) NSDate *creationDate;//创建时间
...
+ (instancetype)modelWithAsset:(id)asset type:(TZAssetModelMediaType)type timeLength:(NSString *)timeLength creationDate:(NSString *)creationDate;
...
@interface XWPhotoDateModel : NSObject
/**  日期信息 */

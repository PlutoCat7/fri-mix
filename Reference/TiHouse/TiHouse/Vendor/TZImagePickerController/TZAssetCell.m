...
@interface TZPhotoPickerCollectionHeaderView()
...
@implementation TZPhotoPickerCollectionHeaderView
...
-(UIButton *)allSelectBtn{
    if (!_allSelectBtn) {
        ...
        [_allSelectBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.equalTo(@(_allSelectBtn.width+20));
        }];
    }
...
-(UILabel *)dateLabel{
    if (!_dateLabel) {
        ...
        _dateLabel.font = [UIFont fontWithName:@"iraKakuProN-W3" size:14];
        _dateLabel.textColor = kRKBNAVBLACK;
        [self addSubview:_dateLabel];
        [_dateLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(@(20));
            make.height.equalTo(self);
            make.right.equalTo(_allSelectBtn.mas_left);
        }];
    }
    return _dateLabel;
}

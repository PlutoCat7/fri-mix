...
- (void)viewDidLoad {
    ...
    if (iOS7Later) {
        self.navigationBar.barTintColor = [UIColor colorWithRed:(100/255.0) green:(34/255.0)  blue:(34/255.0) alpha:1.0];
        self.navigationBar.tintColor = kRKBNAVBLACK;
...
- (void)configDefaultSetting {
    ...
    self.naviTitleColor = kRKBNAVBLACK;
    self.naviTitleFont = [UIFont systemFontOfSize:17];
    self.barItemTextFont = [UIFont systemFontOfSize:15];
    self.barItemTextColor = kRKBNAVBLACK;

...
//    self.networkPhotoUrls = [NSMutableArray array];
    ...
    if (self.type == HXPhotoManagerSelectedTypePhoto) {
        ...
        self.configuration.photoMaxNum = 20;
        self.configuration.videoMaxNum = 0;
        self.configuration.maxNum = 20;
        self.configuration.cellSelectedBgColor = [UIColor clearColor];
        self.configuration.themeColor = kRKBNAVBLACK;
    }
}
        ...
        if (!self.configuration.reverseDate) {
            if (self.configuration.showDateSectionHeader) {
                if (dateArray.count) {
                    ...
                    HXPhotoDateModel *dateModel = [[HXPhotoDateModel alloc] init];

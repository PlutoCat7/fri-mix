...
/**
 是否固定裁剪框
 */
@property (assign, nonatomic) BOOL shouldLockCrop;

/**
 是否隐藏旋转按钮
 */
@property (assign, nonatomic) BOOL hiddenRotationButton;

/**
 是否隐藏还原按钮
 */
@property (assign, nonatomic) BOOL hiddenResetButton;
...
//图片剪切是否为正方形
@property (assign, nonatomic) BOOL ToCarpPresetSquare;

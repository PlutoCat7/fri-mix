...
//        }else {
            _addModel.thumbPhoto = [HXPhotoTools hx_imageNamed:@"pic_add@2x.png"];
//        }
    }
    return _addModel;
}
...
//        }
        [tempAllArray addObjectsFromArray:self.manager.afterSelectedArray];
        [tempPhotoArray addObjectsFromArray:self.manager.afterSelectedPhotoArray];

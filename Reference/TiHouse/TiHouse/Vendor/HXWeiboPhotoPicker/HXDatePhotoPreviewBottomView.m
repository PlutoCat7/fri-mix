...
//            self.collectionView.hx_w = self.editBtn.hx_x;
        ...
        self.doneBtn.hx_x = self.hx_w - 15 - self.doneBtn.hx_w;
        self.editBtn.hx_x = 15;
        self.editBtn.hx_y = self.hx_h - 40;
//        if (!self.hideEditBtn) {
//            self.collectionView.hx_w = self.editBtn.hx_x;
//        }else {
...
- (void)layoutSubviews {
    ...
    self.collectionView.frame = CGRectMake(0, 23,self.hx_w, 50);
    self.doneBtn.frame = CGRectMake(0, self.hx_h-40, 50, 30);
//    self.doneBtn.center = CGPointMake(self.doneBtn.center.x, 25);
    [self changeDoneBtnFrame];
    
    self.lineH.frame = CGRectMake(0, 20+self.collectionView.hx_y+self.collectionView.hx_h, self.hx_w, 0.5);
...
- (UIButton *)editBtn {
    if (!_editBtn) {
        ...
        _editBtn.hx_size = CGSizeMake(50, 30);
        _editBtn.hidden = YES;
    }
    return _editBtn;
}
- (UIView *)lineH {
    if (!_lineH) {
        _lineH = [[UIView alloc] initWithFrame:CGRectMake(0, self.collectionView.hx_h, self.hx_w, 0.5)];

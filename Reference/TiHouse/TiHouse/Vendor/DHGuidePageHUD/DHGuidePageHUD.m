...
////                [imageView sd_setImageWithURL:[NSURL URLWithString:imageNameArray[i]]];
//                [guidePageView addSubview:imageView];
//            }
...
//            [imageView sd_setImageWithURL:[NSURL URLWithString:imageNameArray[i]]];
            ...
            if (i == imageNameArray.count-1 && isHidden == NO) {
                ...
                UIButton *startButton = [[UIButton alloc]initWithFrame:CGRectMake(DDScreenW*0.3, DDScreenH*0.82, 150, kRKBHEIGHT(50))];
                [startButton setTitle:@"开始体验" forState:UIControlStateNormal];
                [startButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
                [startButton.titleLabel setFont:[UIFont systemFontOfSize:[UIFont adjustFontFromFontSize:21]]];
                startButton.backgroundColor = RGB(252, 191, 48);
                startButton.layer.cornerRadius = kRKBHEIGHT(25);
        ...
        self.imagePageControl.currentPageIndicatorTintColor = kTiMainBgColor;

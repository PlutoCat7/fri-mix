...
- (void)makeConstraints
{
    [_bottomControlsBar mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(self).offset(kDevice_Is_iPhoneX ? -34 : 0);
        make.height.equalTo(@30);
    }];
    
    [_playButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(30, 30));
        make.left.equalTo(_bottomControlsBar).offset(15);
        make.centerY.equalTo(_bottomControlsBar);
    }];
...
- (UIButton *)playButton
{
    if (!_playButton){
        ...
        [_playButton setImage:[[UIImage imageNamed:@"fucc_play"] scaleToSize:CGSizeMake(30, 30)] forState:UIControlStateNormal];
        [_playButton setImage:[[UIImage imageNamed:@"fucc_pause"] scaleToSize:CGSizeMake(30, 30)] forState:UIControlStateSelected];
...
- (UIButton *)replayButton
{
    if (!_replayButton) {
        ...
        [_replayButton setImage:[[UIImage imageNamed:@"fucc_replay"] scaleToSize:CGSizeMake(40, 40)] forState:UIControlStateNormal];
...
- (void)replayAction
{
    ...
    if (_replayActionCallback) {
        _replayActionCallback();
    }
}

...
+(void)load{
    ...
    method_exchangeImplementations(class_getInstanceMethod(self.class, NSSelectorFromString(@"setAttributedText:")),
                                   class_getInstanceMethod(self.class, @selector(zwPlaceHolder_swizzled_setAttributedText:)));
}
...
- (void)zwPlaceHolder_swizzled_setAttributedText:(NSAttributedString *)attributedText{
    [self zwPlaceHolder_swizzled_setAttributedText:attributedText];
    if (self.zw_placeHolder) {
        [self updatePlaceHolder];
    }
}

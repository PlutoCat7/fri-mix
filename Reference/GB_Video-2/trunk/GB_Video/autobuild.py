...
#会在桌面创建输出ipa文件的目录
EXPORT_MAIN_DIRECTORY = "wangshiwenautoipa"

# configuration for pgyer
PGYER_UPLOAD_URL = "https://www.pgyer.com/apiv2/app/upload"
DOWNLOAD_BASE_URL = "http://www.pgyer.com"
USER_KEY = "9665f183b580b3dc3e0ac5f36af21074"
API_KEY = "2afb569fb1b4607d362439f626128bf5"
#设置从蒲公英下载应用时的密码
PYGER_PASSWORD = ""
# 蒲公英更新描述
PGYDESC = "auto ipa"
...
def buildArchivePath(tempName):
	...
	archivePath = str(stdoutdata) + '/' + archiveName
	return archivePath
...
def getIpaPath(exportPath):
	...
	(stdoutdata, stderrdata) = process.communicate()
	str1 = stdoutdata.strip()
	ipaName = str1.split('\n')
	print ("ipaName:" + str(ipaName))
	str2 = str(ipaName[3])
	print ("str2:" + str2)
	ipaPath = exportPath + "/" + str2
	print (ipaPath)
	return ipaPath

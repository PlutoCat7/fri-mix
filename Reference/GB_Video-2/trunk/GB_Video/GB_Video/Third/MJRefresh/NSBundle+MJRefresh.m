...
+ (NSString *)mj_localizedStringForKey:(NSString *)key value:(NSString *)value
{
    ...
    NSString *curLanguage = [NSLocale preferredLanguages].firstObject;
    if (bundle == nil || curLanguage == nil || ![curLanguage isEqualToString:language]) {
        // （iOS获取的语言字符串比较不稳定）目前框架只处理en、zh-Hans、zh-Hant三种情况，其他按照系统默认处理
        language = curLanguage == nil ? @"en" : curLanguage;

...
- (void) beginAnalyticsPageView {
    if (![NSString stringIsNullOrEmpty:[self pageName]]) {
        [UMShareManager beginPageView:[self pageName]];
    }
}

- (void) endAnalyticsPageView {
    if (![NSString stringIsNullOrEmpty:[self pageName]]) {
        [UMShareManager endPageView:[self pageName]];
    }
}

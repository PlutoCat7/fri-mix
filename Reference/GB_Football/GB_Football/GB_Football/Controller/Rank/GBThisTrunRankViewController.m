//
//  GBThisTrunRankViewController.m
//  GB_Football
//
...
@interface GBThisTrunRankViewController ()<GBSegmentViewDelegate>
...
@implementation GBThisTrunRankViewController
...
- (void)setupSegmentUI
{
    self.moveDistanceViewController             = [[GBDetialRankViewController alloc]initWithType:DailyRank_This_Distance];
    self.avarageSpeedViewController             = [[GBDetialRankViewController alloc]initWithType:DailyRank_This_AvgSpeed];
    self.highestSpeedViewController             = [[GBDetialRankViewController alloc]initWithType:DailyRank_This_MaxSpeed];

...
#define kWMDragViewWidth 25
#define kWMDragViewDefaultHeight 25
#define kWMDragViewWithNameHeight 40

@class GBTacticsPlayerModel;
...
@interface WMDragView : UIView<UIGestureRecognizerDelegate, XXNibBridge>
...
@property (nonatomic, assign) CGFloat moveScale;  //拖动滑动时view的缩放比例 default 2.0

@property (nonatomic, strong) GBTacticsPlayerModel *tacticsPlayerModel;

...
- (void)setup
{
    ...
    [self attributeTitle:LS(@"forgot.btn.getcode") underLine:YES buttonEnable:YES];
}
-(void)touchUp
{
...
- (void)updateButton
{
    ...
    {
        [self setEnabled:NO];
        [self attributeTitle:[NSString stringWithFormat:@"%li%@", (long)self.currentSeconds, LS(@"forgot.btn.code.again")]
...
-(NSMutableAttributedString*)attributeTitle:(NSString*)string underLine:(BOOL)underLine buttonEnable:(BOOL)buttonEnable
{
    ...
    if (buttonEnable)
    {
        [content addAttribute:NSForegroundColorAttributeName
                        value:[UIColor colorWithHex:0x01ff00]
...
- (void)setButtonEnable:(BOOL)enble
{
    ...
    [self attributeTitle:LS(@"forgot.btn.getcode") underLine:YES buttonEnable:enble];
